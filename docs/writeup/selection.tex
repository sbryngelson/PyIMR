...
Measured on the \SI{15}{\celsius} record at its own $3618$ frames, against the geometry-only
formulation with $N$ pinned at $201$:
...
argument at all. Its \emph{magnitude} is now available even though its direction is not:
...
Scored against the four geometries \cref{sec:survives} put through two synthetic mismatches:
