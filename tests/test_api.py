...
PUBLIC_MODULES = ("pyimr", "pyimr.sensitivity", "pyimr.inference", "pyimr.data", "pyimr.design", "pyimr.pymc_op", "pyimr.assimilation", "pyimr.optimize", "pyimr.pareto", "pyimr.discriminate")
PACKAGE = "pyimr"
