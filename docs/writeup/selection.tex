...
So the claim this document makes is the narrower one. Whatever carries half to three-quarters of
the trial scatter is not the material parameters, at each trial's own optimum; and at the one
record where the initial condition could move freely, it is not that either. Whether a wider
prior on $R_{\rm eq}$ would absorb it at \SI{15}{} and \SI{23}{\celsius} is untested.
