...
We also report what would be needed to do better. Treating a model choice as a parameter puts
discrimination and estimation in one information matrix, and the resulting design measure
carries a Kiefer--Wolfowitz certificate~\citep{kiefer1960equivalence}. The experiments analysed
here are near-optimal for the hardest of the three model axes and $24$ to $41$ times from
optimal for the two easiest.
