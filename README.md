...
| | |
|---|---|
| bubble dynamics | `dynamics=` Rayleigh-Plesset, Keller-Miksis, Keller enthalpy, Herring, Gilmore; the last three take `liquid_eos=` Tait, Mie-Gruneisen or Noble-Abel stiffened gas |
