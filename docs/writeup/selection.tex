...
estimator of~\eqref{eq:ess} the $201$ samples carry the information of about
...
Lindley--Jeffreys effect, and it is not a defect to be engineered away: a model whose prior is
...
Wolfowitz, and it is the object this whole section exists to obtain: a quantity that can be
...
The implementation uses the multiplicative algorithm of Silvey, Titterington and Torsney,
%
\begin{equation}
...
$u_x - u^{\mathsf T}\xi$. This is the compound-criterion construction of Atkinson and of Cook
and Wong, and it is the principled form of the estimation-versus-discrimination trade this
...
of Gutenkunst, Sethna and co-workers, and the reason parameter values in such models are
...
correlated measurement noise. Kennedy and O'Hagan formalise this by writing
