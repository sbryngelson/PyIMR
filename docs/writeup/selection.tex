...
the rest is not. But the character of the question has changed: this is no longer a mode with no
candidate, it is a mode with one identified mechanism carrying a quarter of it and a remainder
that the same normalisation may well be leaving behind in a form the linear direction does not
capture.
