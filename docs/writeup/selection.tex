...
problem, and that split is worth $+3.9$ to $+5.8$ nats against at most $1.34$ for the geometry.
...
$0.191$ nats is small. It is less than restoring testability ($0.24$), a seventh of choosing the
geometry under the right noise model ($1.34$), a sixth of merely accounting for the scatter
(\cref{sec:setpoint}, $1.118$), and a twentieth of the bubbles-against-frames split
(\cref{sec:allocation}, $3.93$). Perfect control of the stretch is worth less still, $+0.100$.
