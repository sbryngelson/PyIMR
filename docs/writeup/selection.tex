...
theorem then certifies the answer -- over the candidate set. That qualifier is load-bearing. On a
grid eight times finer the sensitivity reaches $69.6$ against a bound of $4$, and refining the
candidate set to that grid reduces the excess to $2.9$ without removing it: the optimum is
provably best among the settings offered, not over the continuum.
...
The consequence is a genuine limitation on this chapter's strongest claim, and it is the honest
version of the caveat this list previously carried. \emph{Every certified batch here is optimal
over its candidate set and none is proved optimal over the continuum.} The scan says where to
refine --- around \SI{550}{\micro\metre} at high stretch --- and refining there will move the
answer.
