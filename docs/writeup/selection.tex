...
We do not know why. The candidate differences are stated rather than resolved: a different
material at a different stretch, $7$ to $18$ trials against $84$ to $253$ events, and minima
located on $201$ samples spanning five collapse times, where a one-sample error in a knot is
comparable to the collapse-time scatter the warp is trying to remove. Any of those could be
responsible and this document cannot separate them.
