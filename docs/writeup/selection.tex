...
by an inner minimum is multimodal here and every improvement to the optimizer lowers it.
...
\begin{center}
\textit{[table: operator evidence against Keller--Miksis, by prior width, three records]}
\end{center}
