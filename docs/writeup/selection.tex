...
So the claim can now be made at full strength rather than narrowly. \emph{Whatever carries half
to three-quarters of the trial scatter is not any quantity this model has}: not the material
