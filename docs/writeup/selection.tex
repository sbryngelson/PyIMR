...
\paragraph{What this says.} Nothing on the list accounts for the discrepancy. Every genuine
...
phase, for the reason \cref{sec:noisedesign} gives for $\sigma$ --- settles what it does to the
...
assumed. Weaker, because $\Sigma$ is a population covariance of \emph{material} parameters --- a
...
Carrying it to an unrun geometry needs the transfer of \cref{sec:noisedesign}, and the premise is
checkable rather than assumed. Resampled onto a common $t/t_c$ grid, the three records'
