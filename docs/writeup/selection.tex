...
absorption. Whatever carries half to three-quarters of the trial scatter, it is not the
parameters of this model --- not linearly, and not at each trial's own optimum either.
