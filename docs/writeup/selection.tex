...
That is a specific and testable statement, and it is where the question now sits: not what the
mode is, but whether a \emph{two}-timescale alignment --- collapse and rebound separately, both
measurable per event --- removes what one cannot.
