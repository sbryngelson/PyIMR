...
near $8.1$; the records come from \citet{abeid2024experimental} at $277$, $298$ and
\SI{312}{\micro\metre} and stretches $7.09$, $7.37$ and $6.83$. A mechanism shown on one is a
...
So neither resolution nor replication accounts for it, and what remains is the experiment. The
sweep is a different material at a different stretch, processed by the same pipeline; the mode
each dataset shows under the inertial clock looks alike --- both dilation-aligned --- and only one
of them is a two-timescale clock error. They may not be the same phenomenon at all, which is a
sharper statement than this section could make before and a worse one for anybody hoping a
processing change fixes these records.
...
measurement. \citet{abeid2024experimental} tabulate it as a mean over the experiments in each
bin, with a spread: $7.09 \pm 0.36$ over $18$ events, $7.37 \pm 1.28$ over $14$, and
$6.83 \pm 0.49$ over $7$. Against those the preferred values sit at $1.9$, $0.45$ and $0.49$
