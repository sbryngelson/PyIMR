...
the certificate back in two steps. Which settings to guarantee is decided by the certificate
itself --- those the free solution already funds, then the candidates of largest sensitivity,
the ones \eqref{eq:equivalence} shows the free problem came closest to wanting. Naming them is
